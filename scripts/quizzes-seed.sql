...
INSERT INTO
	quizzes (title, description, question_text)
VALUES
	(
		'General Knowledge',
		'A quiz about general knowledge',
	...
	(
		'Alicante Knowledge',
		'A quiz about general knowledge of Alicante, Spain',
		'What is the main beach in Alicante?'
	);

-- Seed data into answers table
INSERT INTO
	answers (quiz_id, answer_text, is_correct)
VALUES
	(1, 'Paris', TRUE),
	(1, 'London', FALSE),
	(1, 'Berlin', FALSE),
